...
import { getChannel, getMultipleChannels } from './api/channels.js';
import { getVideo, getMultipleVideos, getChannelVideos } from './api/videos.js';
 ...
 */
export async function compareChannels(channelIds) {
 ...
 */
export async function searchAndAnalyze(query, maxResults = 10) {
    console.log(`\n🔍 Searching for "${query}"...`);
