...
Coolify | coolify+coolify-realtime+coolify-sentinel+coolify-proxy | coolify-db (PG17)+coolify-redis | coolify | 127.0.0.1:8000 / 443  

Databases  
Overlord: mastercommander-db  
SurfaBabe: surfababe-db  
NamiBarden: namibarden-db (Traefik-lab)  
Lumina: lumina-db  
OnlyHulls: onlyhulls-db  
Coolify: coolify-db (PG17)+coolify-redis  
